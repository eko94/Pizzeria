...
{
    public class QuesoMozzarella : IQuesoStrategy
    {
        public Pizza AddQueso(string tipo, Pizza pizza)
        {
            pizza.Ingredientes.Add(Constants.IngredientesConstants.Queso + " " + Constants.IngredientesConstants.Tipos.Quesos.Mozzarella);
            return pizza;
        }
    }
}
